...
namespace SpadCompanyPanel.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new SpadCompanyPanel.Web.Models.ApplicationUser { UserName = model.Email, Email = model.Email };
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    FromName = "SpadCompanyPanel Way Team",
                    FromEmail = "SpadCompanyPanelWayTeam@gmail.com",
                    ToEmail = user.Email,
